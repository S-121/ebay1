...

    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('./views/products/research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          component: () => import('./views/category/research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          component: () => import('./views/competitor/research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/titleBuilder',
          name: 'TitleBuilder',
          component: () => import('./views/titleBuilder/titleBuilder.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/zik_pro',
          name: 'ZIK Pro',
          component: () => import('./views/zik_pro/zik_pro.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/user_admin',
          name: 'User Admin',
          component: () => import('./views/user_admin/user_admin.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        },
        {
          path: '/ali_hot_items',
          name: 'Ali Items',
          component: () => import('./views/school/ali_hot_items.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/amazon_hot_items',
          name: 'Amazon Items',
          component: () => import('./views/school/amazon_hot_items.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/englishcourse',
          name: 'EnglishCourse',
          component: () => import('./views/school/academy/englishcourse.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/hebrewcourse',
          name: 'HebrewCourse',
          component: () => import('./views/school/academy/hebrewcourse.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/zikprocourse',
          name: 'ZikProCourse',
          component: () => import('./views/school/academy/zikprocourse.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/facebookads',
          name: 'FacebookAds',
          component: () => import('./views/school/academy/facebookads.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/englishwebinars',
          name: 'EnglishWebinars',
          component: () => import('./views/school/academy/englishwebinars.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/hebrewwebinars',
          name: 'HebrewWebinars',
          component: () => import('./views/school/academy/hebrewwebinars.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/englishevents',
          name: 'EnglishEvents',
          component: () => import('./views/school/academy/englishevents.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/academy/hebrewevents',
          name: 'HebrewEvents',
          component: () => import('./views/school/academy/hebrewevents.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/setup_account',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/setup_account.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/ebay_algorithm',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/ebay_algorithm.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/retails_sales',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/retails_sales.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/average_selling_price',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/average_selling_price.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/suitable_competitors',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/suitable_competitors.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/your_competitors',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/your_competitors.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/uncover',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/uncover.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/sellers',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/sellers.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/high_profit_items',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/high_profit_items.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/discover',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/discover.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/suppliers',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/suppliers.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/intuition',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/intuition.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/generic',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/generic.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/indepth_practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/indepth_practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/quick_practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/quick_practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/item_specifics',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/item_specifics.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/category_research',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/category_research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_englishcourse/google_trends',
          name: 'Setup Account',
          component: () => import('./views/school/child_englishcourse/google_trends.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        //===============================================================================
        {
          path: '/child_hebrewcourse/setup_account',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/setup_account.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/ebay_algorithm',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/ebay_algorithm.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/retails_sales',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/retails_sales.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/average_selling_price',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/average_selling_price.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/suitable_competitors',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/suitable_competitors.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/your_competitors',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/your_competitors.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/high_profit_items',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/high_profit_items.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/uncover',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/uncover.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/sellers',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/sellers.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/discover',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/discover.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/suppliers',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/suppliers.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/intuition',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/intuition.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/generic',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/generic.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/indepth_practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/indepth_practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/quick_practice',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/quick_practice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/item_specifics',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/item_specifics.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/category_research',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/category_research.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_hebrewcourse/google_trends',
          name: 'Setup Account',
          component: () => import('./views/school/child_hebrewcourse/google_trends.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        //===================================
        {
          path: '/child_zik/lesson2',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson2.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_zik/lesson3',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson3.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_zik/lesson4',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson4.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_zik/lesson5',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson5.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_zik/lesson6',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson6.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_zik/lesson7',
          name: 'Setup Account',
          component: () => import('./views/school/child_zik/lesson7.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        //===========================================
        {
          path: '/child_facebook/chapter2',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter2.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter3',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter3.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter4',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter4.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter5',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter5.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter6',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter6.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter7',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter7.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter8',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter8.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter9',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter9.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/chapter10',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/chapter10.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/bonus1',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/bonus1.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/child_facebook/bonus2',
          name: 'Setup Account',
          component: () => import('./views/school/child_facebook/bonus2.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/analytic',
          name: 'Analytic',
          component: () => import('./views/products/analitic.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/alianalytic',
          name: 'Alianalytic',
          component: () => import('./views/products/alianalitic.vue'),
          meta: {
            rule: 'admin'
          }
        },
        ...
        //=============================================================================
        {
          path: '/management_panel/my_saved_search',
          name: 'my_saved_search',
          component: () => import('./views/management_panel/my_saved_search.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/my_folders',
          name: 'my_folders',
          component: () => import('./views/management_panel/my_folders.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/folders/files',
          name: 'files',
          component: () => import('./views/management_panel/folders/files.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/my_competitor_list',
          name: 'my_competitor_list',
          component: () => import('./views/management_panel/my_competitor_list.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/waitinglist',
          name: 'waitinglist',
          component: () => import('./views/management_panel/waitinglist.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/manage_payments',
          name: 'manage_payments',
          component: () => import('./views/management_panel/manage_payments.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/view_invoice/invoice',
          name: 'invoice',
          component: () => import('./views/management_panel/view_invoice/invoice.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/view_invoice/upgrade',
          name: 'upgrade',
          component: () => import('./views/management_panel/view_invoice/upgrade.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/view_invoice/payment',
          name: 'payment',
          component: () => import('./views/management_panel/view_invoice/payment.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/affiliate_manager',
          name: 'affiliate_manager',
          component: () => import('./views/management_panel/affiliate_manager.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          ...
          name: 'request_payout',
          component: () => import('./views/management_panel/payout/request_payout.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/add_store',
          name: 'add_store',
          component: () => import('./views/management_panel/add_store.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/annesley',
          name: 'annesley',
          component: () => import('./views/management_panel/annesley.vue'),
          meta: {
            rule: 'admin'
          }
        },
        {
          path: '/management_panel/my_settings',
          name: 'my_settings',
          component: () => import('./views/management_panel/my_settings.vue'),
          meta: {
            rule: 'admin'
          }
        },
...
router.beforeEach((to, from, next) => {
  ...
  //   }
  // }
  // console.log('login status', localStorage.getItem("accessToken"))
  store.dispatch('products/refresh_token')
    .then((response) => {
      return next();
    })
    .catch(error => {
