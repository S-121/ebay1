...
export default [
  ...
  },
  {
    ...
    slug: 'products-research',
    icon: 'SearchIcon',
    i18n: 'Products research'
  },
  {
  ...
  },
  {
    ...
    icon: 'UserPlusIcon',
    i18n: 'Competitor research'
  },
  {
    url: '/titleBuilder',
    name: 'TitleBuilder research',
    slug: 'titleBuilder',
    icon: 'PenToolIcon',
    i18n: 'TitleBuilder research'
  },
  {
    url: '/zik_pro',
    name: 'ZIK Pro',
  ...
  },
  {
    ...
    icon: 'SettingsIcon',
    i18n: 'Management Panel',
    submenu: [
      {
        url: '/management_panel/my_saved_search',
        name: 'My Saved Search',
        slug: 'management_panel-my_saved_search',
        i18n: 'My Saved Search'
      },
      {
        url: '/management_panel/my_folders',
        name: 'My Folders',
        slug: 'management_panel-my_folders',
        i18n: 'My Folders'
      },
      {
        url: '/management_panel/my_competitor_list',
        name: 'My Competitor List',
        slug: 'management_panel-my_competitor_list',
        i18n: 'My Competitor List'
      },
      {
        url: '/management_panel/waitinglist',
        name: 'WaitingList',
        slug: 'management_panel-waitinglist',
        i18n: 'WaitingList'
      },
      {
        url: '/management_panel/manage_payments',
        name: 'Manage Payments',
        slug: 'management_panel-manage_payments',
        i18n: 'Manage Payments'
      },
      {
        url: '/management_panel/affiliate_manager',
        name: 'Affiliate Manager',
        slug: 'management_panel-affiliate_manager',
        i18n: 'Affiliate Manager'
      },
      {
        // url: '/management_panel/store_analytics',
        // name: 'Store Analytics',
        // slug: 'management_panel-store_analytics',
        // i18n: 'Store Analytics'
        url: null,
        name: 'Store Analytics',
        i18n: 'Store Analytics',
        submenu: [
          {
            url: '/management_panel/add_store',
            name: 'Add store',
            slug: 'management_panel-add_store',
            i18n: 'Add store'
          },
          {
            url: '/management_panel/annesley',
            name: 'annesley_9223',
            slug: 'management_panel-annesley',
            i18n: 'annesley_9223'
          }
        ]
      },
      {
        url: '/management_panel/my_settings',
        name: 'My Settings',
        slug: 'management_panel-my_settings',
        i18n: 'My Settings'
      }
    ]
  },
